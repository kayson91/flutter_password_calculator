...
/// ofended.
class FlutterPasswordCalculatorController extends ChangeNotifier {
  late Set<ValidationRule> _rules;
  final Set<ValidationRule> _ofendingRules = {};

  /// Returns the rules of the [FlutterPasswordCalculator]
  ...
  /// Reacts to onChanged of the [FlutterPasswordCalculator]
  ///
