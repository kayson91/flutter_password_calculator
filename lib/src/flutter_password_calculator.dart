...
class FlutterPasswordCalculator extends StatefulWidget {
  ...
  /// Widget.
  final FlutterPasswordCalculatorController? passwordController;
...
class _FlutterPasswordCalculatorState extends State<FlutterPasswordCalculator> {
  ...
  late FlutterPasswordCalculatorController _passwordController;

  @override
  void initState() {
    _passwordController = (widget.passwordController ??
        FlutterPasswordCalculatorController())
